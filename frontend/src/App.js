    ...
    <div className="min-h-screen flex flex-col" data-testid="landing-page">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-header">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={() => { setShowAuthModal(true); setAuthMode('login'); }} className="btn-primary px-4 py-2 rounded-lg text-sm font-medium">
              Get Started
            </button>
          </div>
        </div>
        ...
        <div className="max-w-4xl text-center animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-4 rounded-2xl font-medium text-muted-foreground hover:text-foreground hover:bg-secondary/50 transition-all"
            >
      ...
      {showAuthModal && (
        <AuthModal 
          ...
          onClose={() => { setShowAuthModal(false); setAuthMethod(null); }}
          mode={authMode}
          setMode={setAuthMode}
          method={authMethod}
